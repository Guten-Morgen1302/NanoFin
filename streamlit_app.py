...
def main():
    st.set_page_config(page_title="NanoFin - Nano Entrepreneur Analysis", layout="wide", page_icon="🏛️")
    ...
    <div style='text-align: center; padding: 20px; background: linear-gradient(90deg, #667eea 0%, #764ba2 100%); color: white; border-radius: 10px; margin-bottom: 30px;'>
        ...
        <p><strong>Built by Team ConsoleLog for AI & Data Science Codeathon 2024</strong></p>
    </div>
    ...
    **Sample JSON Structure**:
    ...
    <div style='text-align: center; padding: 20px; color: #666;'>
        ...
        <p><strong>Team ConsoleLog</strong> - AI & Data Science Codeathon 2024</p>
        <p>🏆 Revolutionizing Credit Access for Unbanked Nano-Entrepreneurs</p>
    </div>
    """, unsafe_allow_html=True)
